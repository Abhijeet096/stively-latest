      ...
      <div className="min-h-screen bg-white">
        ...
        <article className="container mx-auto px-4 py-12 max-w-4xl">
          ...
          <div className="flex items-center gap-3 mb-6">
            <Badge className="bg-purple-600">{blog.category}</Badge>
            <span className="text-sm text-gray-500">👁️ {blog.views}</span>
          ...
          <div className="flex items-center gap-2 mb-8">
            ...
            <div>
              <p className="font-medium">{blog.author?.name || "Stively Team"}</p>
          ...
          <div className="mt-12 pt-8 border-t">
            <div className="flex flex-col gap-6">
              {/* Like Button */}
              <div>
                <h3 className="font-bold mb-3">Enjoyed this article?</h3>
                <Button 
                  onClick={handleLike}
                  disabled={hasLiked}
                  className={hasLiked ? "bg-gray-400" : "bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-600 hover:to-pink-600"}
                  size="lg"
                >
                  {hasLiked ? "❤️ Liked!" : "❤️ Like This Article"} ({likeCount})
                </Button>
              </div>
