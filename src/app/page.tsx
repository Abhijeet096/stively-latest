          ...
          {featuredArticles.length > 0 ? (
            ...
            <div className="text-center py-16">
              ...
              <div className="mb-6 flex justify-center">
                <div className="bg-gradient-to-br from-purple-100 to-blue-100 p-8 rounded-full">
                  <svg 
              ...
              <p className="text-gray-600 mb-8 max-w-md mx-auto">
                We're curating the best content for you. Check back soon or explore our latest articles!
              </p>
